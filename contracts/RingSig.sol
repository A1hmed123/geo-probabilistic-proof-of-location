...
contract RingMixerV2 {
    ...
    function HashFunction(bytes message, uint256[2] left, uint256[2] right)
    ...
    function RingStartingSegment(bytes message, uint256 alpha, uint256[2] P0)
    ...
    function RingSegment(bytes message, uint256 c0, uint256 s0, uint256[2] P0, uint256[2] Ix)
    ...
    //=== RingSignatureN ===
    //Inputs:
    //  message (bytes) - to be signed by the ring signature
    ...
    function RingSign(bytes message, uint256[] data)
    ...
    function RingSign_User(bytes message, uint256[] data)
    ...
    //=== RingVerifyN ===
    //Inputs:
    //  message (bytes) - signed by the ring signature
    ...
    function RingVerify(bytes message, uint256[] signature)
    ...
    function RingVerify_User(bytes message, uint256[] signature)
